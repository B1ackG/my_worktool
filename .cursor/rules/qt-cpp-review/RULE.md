...
python .cursor/skills/qt-cpp-review/references/lint-scripts/qt_review_lint.py <files...>
```
...
**References**: `.cursor/skills/qt-cpp-review/references/qt-review-checklist.md` § Model
Contracts
...
**References**: `.cursor/skills/qt-cpp-review/references/qt-review-checklist.md` § Ownership
...
**References**: `.cursor/skills/qt-cpp-review/references/qt-review-checklist.md` § Thread
Safety
...
**References**: `.cursor/skills/qt-cpp-review/references/qt-review-checklist.md` § API &
...
**References**: `.cursor/skills/qt-cpp-review/references/qt-review-checklist.md` § Error
Handling & Validation
...
**References**: `.cursor/skills/qt-cpp-review/references/qt-review-checklist.md` §
...
- `.cursor/skills/qt-cpp-review/references/qt-review-checklist.md` — Universal Qt6 C++ review
  rules (always loaded)
- `.cursor/skills/qt-cpp-review/references/qt-framework-checklist.md` — Qt framework/module
  development rules (loaded only in framework mode)
- `.cursor/skills/qt-cpp-review/references/qt-deprecated-classes.md` — Classes and patterns
  that should no longer be used in Qt implementation
- `.cursor/skills/qt-cpp-review/references/lint-scripts/qt_review_lint.py` — Single-pass
